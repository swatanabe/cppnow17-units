...
int main() {
    ...
    std::cout << typeid(mass).name() << std::endl;
    std::cout << typeid(time).name() << std::endl;
    std::cout << typeid(velocity).name() << std::endl;
    std::cout << typeid(dimensionless).name() << std::endl;
    std::cout << typeid(force).name() << std::endl;
    std::cout << typeid(energy).name() << std::endl;
}
